...
async def left_green_turn():
    ...
    # turn left
    await motor_pair.move_for_degrees(motor_pair.PAIR_1, 60, -100, velocity=280)

    # turn right until right sensor sees black
    ...
    # go forward
    await motor_pair.move_for_degrees(motor_pair.PAIR_1, 30, 0, velocity=280)
